...
__attribute__((section("__versions"))) = {
	...
	{ 0xa08a1d23, __VMLINUX_SYMBOL_STR(gpiod_direction_input) },
	{ 0xd89c9107, __VMLINUX_SYMBOL_STR(gpiod_direction_output_raw) },
...
MODULE_INFO(srcversion, "E8F2046854AFD8ADD6C2C89");
